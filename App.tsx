...
import { Expense, ExpenseDraft, ViewState } from './types';
import { LayoutGrid, Plus, List, Settings as SettingsIcon, Loader2 } from 'lucide-react';
import { appendToSheet, getScriptConfig } from './services/sheetService';
...
const App: React.FC = () => {
  ...
  const handleSaveExpense = async (drafts: ExpenseDraft[]) => {
    const newExpenses: Expense[] = drafts.map(d => ({
